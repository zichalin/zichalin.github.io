		...
		try {
			...
			for (FileItem fileItem : list) {
				if (fileItem.isFormField()) {
					...
					case "id":
						goods.setId(Integer.parseInt(fileItem.getString("utf-8")));
					case "name":
						goods.setName(fileItem.getString("utf-8"));
						break;
					case "cover":
						goods.setCover(fileItem.getString("utf-8"));
						break;
					case "image1":
						goods.setImage1(fileItem.getString("utf-8"));
						break;
					case "image2":
						goods.setImage2(fileItem.getString("utf-8"));
						break;
					case "price":
					...
					case "typeid":
						...
						break;
					case "pageNumber":
						pageNumber = Integer.parseInt(fileItem.getString("utf-8"));
						break;
					case "type":
