...
import com.cakeshop.utils.PriceUtil;
...
public class Order {
	...
	private int status;		//付款状态，1、未付款，2、已付款，3、已发货，4、已完成
	private int paytype;	//付款方式，1、微信，2、支付宝，3、货到付款
	private String name;
	...
	public void setItemList(List<OrderItem> ltemList) {
		this.itemList = ltemList;
	}
